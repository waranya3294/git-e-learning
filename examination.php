...
<script>
  const questions = [
    ...
    },
    {
      ...
      options: [
        "1. พ่นสีเพิ่มทันที",
        "2. ปล่อยให้แห้งแล้วขัดพื้นผิวก่อนพ่นซ้ำ",
        "3. ใช้ความร้อนเร่งให้ฟองอากาศแตก",
        "4. พ่นสีใสเคลือบทับทันที"
      ]
    },
    {
      ...
      options: [
        ...
        "3. ทำให้สีไม่หลุดลอก",
        "4. ให้ตกแต่งเพื่อความสวยงาม"
      ]
    },
    {
      title: "ข้อที่ 4 ในการพ่นสี ควรเลือกใช้อุปกรณ์ป้องกันส่วนบุคคล(PPE)ใด เพื่อป้องกันการสูดดมสารเคมีที่อาจเป็นอันตราย?",
      options: [
        "1. หน้ากาผ้า",
        "2. หน้ากากกรองอากาศแบบไส้กรองมาตรฐาน",
        "3. หมวกนิรภัย",
        "4. แว่นกันแดด"
      ]
    },
  ...
  nextButton.addEventListener('click', () => {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      alert('คุณทำข้อสอบครบแล้ว');
      window.location.href = 'learning_maincontent.php'; // ไปหน้าเรียน
    }
  });
