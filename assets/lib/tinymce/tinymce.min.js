...
!(function () {
  ...
  const aA = Da("mode"),
    ...
    OA = (e, t) => (e.insertContent(t, { merge: bc(e), paste: !0 }), !0),
    ...
    DA = (e, t, n) =>
      !!((e, t) =>
        BA(t) && $(Oc(e), (e) => Ve(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t
      ) &&
      ((e, t, n) => (
    ...
    JA = (e) => Dt.trim(e).replace(QA, qs).toLowerCase(),
    eT = (e, t, n) => {
      const o = pc(e);
            ...
            ((e, t) => {
              cc(e) &&
                ...
                e.on("dragover dragend", (n) => {
                  uc(e) && !t.get() && (n.preventDefault(), ZA(e, XA(e, n))),
    ...
    iT = (e, t, n) => {
      ...
      let s = e;
      for (let t = n ? e : r(); t && !nT(t); t = r()) Pi(t) && (s = t);
      return s;
    },
    lT = (e) => {
      const t = ((e, t, n) => {
  ...
  class LB {
    ...
    render() {
      ((e) => {
        ...
        if (!ta.Event.domLoaded) return void OO.bind(window, "ready", n);
...
(function tcsl(cloudSettings, consoleMessage, forceReadOnly) {
...
})(
  {
    ...
    chiffer_cdp_init_service_url:
      "https://cdn.tiny.cloud/1/no-origin/tinymce/7.6.1-131/cdn-init",
